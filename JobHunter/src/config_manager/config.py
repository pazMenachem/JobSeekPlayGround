...
JOB_FILTER_LEVEL = "yes"  # Filtering level: "yes", "no", "maybe", "all"
JOB_FILTER_PROMPT = "Is this job relevant for a software developer? Answer with one word: yes, no, or maybe."
